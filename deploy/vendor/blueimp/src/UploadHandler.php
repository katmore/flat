<?php
/**
 * defines \blueimp\UploadHandler class
 * 
 * @author Doug Bird - implemented namespacing and fixed some careless errors.
 * @author Copyright 2010, Sebastian Tschan https://blueimp.net
 */
/*
 * original source:
 * 
...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'The uploaded file exceeds the maximum size of %upload_max_filesize%.',
        ...
        'post_max_size' => 'The uploaded file exceeds the maximum size of %post_max_size%.',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
       ...
       foreach ($this->error_messages as &$msg) { 
         $msg = str_replace("%post_max_size%",$post_max_size,$msg);
         $msg = str_replace("%upload_max_filesize%",$upload_max_filesize,$msg);
       }
        $this->options = array(
