...
abstract class facebook extends \flat\asset 
implements 
   \flat\asset\base,
   \flat\asset\resource\transform
{
   ...
   /**
    * retrieves facebook username, needed for forming facebook url
    * 
    * @return string
    */
   abstract protected function _get_facebook_username();
   public function _get_base() {
      return self::facebook_url."/".$this->_get_facebook_username();
   }
   /**
