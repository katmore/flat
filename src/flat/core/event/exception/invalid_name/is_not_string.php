 ...
 * 
 * Purpose:
 *    thrown if event name is not a string
 *
 *
 * PHP version >=5.6
 *
 ...
 * 
 */
namespace flat\core\event\exception\invalid_name;
class is_not_string extends \flat\core\event\exception\invalid_name {
   public function __construct() {
      parent::__construct("name must be a string");
   }
}