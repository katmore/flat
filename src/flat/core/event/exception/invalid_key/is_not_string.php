 ...
 * 
 */
namespace flat\core\event\exception\invalid_key;
class is_not_string extends \flat\core\event\exception\invalid_key {
   public function __construct() {
      parent::__construct("key must be a string");
   }
}