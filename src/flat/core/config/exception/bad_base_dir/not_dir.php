 ...
 * 
 * Purpose:
 *    thrown if config base dir is not a directory
 *
 *
 * PHP version >=5.6
 *
...
class not_dir extends \flat\core\config\exception\bad_base_dir {
   public function __construct() {
      parent::__construct("config base_dir must be directory");
   }
}