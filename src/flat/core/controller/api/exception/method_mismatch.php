 ...
 * 
 * Purpose:
 *    thrown by api controller when resolved request class is not an instanceof \flat\api\method\{method}
 *
 *
 * PHP version >=7.1
 *
...
class method_mismatch extends \flat\core\controller\api\exception {
   public function __construct($method) {
      parent::__construct("requested method '$method' does not match api interface");
   }
}