...
/**
 * File:
 *    cannot_get_property.php
 * 
 * Purpose:
 *    thrown if can't read a property value
 *
 *
 * PHP version >=7.1
 *
...
class cannot_get_property extends \flat\core\mappable\exception {
   public function __construct($property,$reason) {
      parent::__construct(
         "mapper cannot get property: $property reason: $reason"
      );
   }
}