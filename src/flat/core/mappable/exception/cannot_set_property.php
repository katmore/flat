...
/**
 * File:
 *    cannot_set_property.php
 * 
 * Purpose:
 *    thrown if can't write a property value
 *
 *
 * PHP version >=5.6
 *
...
class cannot_set_property extends \flat\core\mappable\exception {
   public function __construct($property,$reason) {
      parent::__construct(
         "mapper cannot set property: $property reason: $reason"
      );
   }
}