 ...
 * 
 */
namespace flat\core\collection\member\validator\exception;
class failed extends \flat\core\collection\member\validator\exception {
   public function __construct($reason="") {
      $msg = "data in collection failed validation";
